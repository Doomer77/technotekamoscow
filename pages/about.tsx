        ...
        <div className={styles.about_info}>
          ...
          <div className={styles.about_info_content}>
            ...
            <p className={styles.about_info_text}>
              ...
              разбирающиеся в технике Apple, Samsung, Xiaomi, Huawei и других, а
              также в программировании. Очень часто в своей работе сервисные
              инженеры используют специальные сторонние наработки для облегчения
              работы и экономии Вашего времени. Одним словом, сервисный инженер
              - это главная единица нашего штата сотрудников!
            </p>
          </div>
        </div>
